...
else
{
	...
	String sql = "SELECT cid, fname FROM Customer WHERE cid = ?";	
	...
	try 
	{
		...
		{	custName = rst.getString(2);
			...
			sql = "INSERT INTO OrderTable (cid, total, orderDate) VALUES(?, 0, NULL);";
			...
			// Update order total
			sql = "UPDATE OrderTable SET total=? WHERE oid=?";
			pstmt = con.prepareStatement(sql);
